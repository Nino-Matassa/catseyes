...
public class TVCountry extends TV
 {
  ...
  public void populateTableCountry() {
    ...
    tkv.key = "Population"; tkv.value = String.valueOf(formatter.format(cursor.getLong(cursor.getColumnIndex("population"))));tkvs.add(tkv); tkv.countryId = id; tkv.field = "population"; tkv = new TableKeyValue();
