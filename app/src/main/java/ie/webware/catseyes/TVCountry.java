...
public class TVCountry extends TV
 {
  ...
  public void populateTableCountry() {
    ...
    tkv.key = "Country Code"; tkv.value = (cursor.getString(cursor.getColumnIndex("COUNTRY_CODE"))); tkvs.add(tkv); tkv.tableId = id; tkv.field = "COUNTRY_CODE"; tkv.subClass = "TVCountry"; tkv = new TableKeyValue();
    tkv.key = "Region"; tkv.value = cursor.getString(cursor.getColumnIndex("continent")); tkvs.add(tkv); tkv.tableId = id; tkv.field = "continent"; tkv.subClass = "TVCountry"; tkv = new TableKeyValue();
    tkv.key = "Country"; tkv.value = cursor.getString(cursor.getColumnIndex("location"));  tkvs.add(tkv); tkv.tableId = id; tkv.field = "location"; tkv.subClass = "TVCountry"; tkv = new TableKeyValue();
    tkv.key = "Population"; tkv.value = String.valueOf(formatter.format(cursor.getLong(cursor.getColumnIndex("population"))));tkvs.add(tkv); tkv.tableId = id; tkv.field = "population"; tkv.subClass = "TVCountry"; tkv = new TableKeyValue();
    ...
    cursor.moveToFirst();
    tkv.key = "Last Updated"; tkv.value = cursor.getString(cursor.getColumnIndex("date")); try { tkv.value = new SimpleDateFormat("yyyy-MM-dd").parse(tkv.value).toString(); String[] arrDate = tkv.value.split(" "); tkv.value = arrDate[0] + " " + arrDate[1] + " " + arrDate[2] + " " + arrDate[5]; } catch(ParseException e) { Log.d("TVCountry", e.toString()); } finally { tkvs.add(tkv);} tkv.tableId = id; tkv.field = "date"; tkv.subClass = "TVCountry"; tkv = new TableKeyValue();
    tkv.key = "New Cases"; tkv.value = String.valueOf(formatter.format(cursor.getLong(cursor.getColumnIndex("new_cases")))); tkvs.add(tkv); tkv.tableId = id; tkv.field = "new_cases"; tkv.subClass = "TVCountry"; tkv = new TableKeyValue();
