...
class Database 
{
 ...
 public static SQLiteDatabase getExistingInstance(Context context)
 {
  if (instance == null)
  {
   java.io.File pathDB = context.getDatabasePath(Constants.dbName);
   if(pathDB.exists())
    instance = SQLiteDatabase.openDatabase(pathDB.getPath(), null, SQLiteDatabase.OPEN_READWRITE);
  }
  return instance;
 }
}
